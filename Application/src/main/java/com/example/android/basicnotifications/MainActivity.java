...
public class MainActivity extends Activity {
    ...
    public void sendNotification(View view) {
        ...
        String conversationName = "Iuri Menin";
        NotificationCompat.CarExtender.UnreadConversation.Builder unreadBuilder =
                new NotificationCompat.CarExtender.UnreadConversation.Builder(conversationName)
                .setReadPendingIntent(msgHeardPendingIntent)
                .setReplyAction(msgReplyPendingIntent, remoteInput);

        unreadBuilder.addMessage("Hello there, how are you?")
        ...
        builder.extend(new NotificationCompat.CarExtender().setUnreadConversation(unreadBuilder.build()));
